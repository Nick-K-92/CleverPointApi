...
GO
INSERT [dbo].[Tickets] ([Id], [Title], [Description], [ShipmentID], [ShipmentTrackingNumber], [EstimatedStoryPoints], [SpentStoryPoints], [DateCreated], [DateClosed], [StatusId], [CreatorUserId], [AssigneeUserId]) VALUES (1, N'Create a new Repo', N'Create a new repo for an Angular application in angular 14', N'000001', N'000000001', 2, 1, CAST(N'2024-07-13T14:53:27.4220000' AS DateTime2), CAST(N'2024-07-13T14:53:27.4220000' AS DateTime2), 1, 1, 2)
GO
INSERT [dbo].[Tickets] ([Id], [Title], [Description], [ShipmentID], [ShipmentTrackingNumber], [EstimatedStoryPoints], [SpentStoryPoints], [DateCreated], [DateClosed], [StatusId], [CreatorUserId], [AssigneeUserId]) VALUES (2, N'Create the Repo', N'Create the repo for the new Api solution', N'000002', N'000000001', 1, 1, CAST(N'2024-07-13T15:31:14.8870000' AS DateTime2), CAST(N'2024-07-13T16:31:14.8870000' AS DateTime2), 5, 2, 1)
GO
INSERT [dbo].[Tickets] ([Id], [Title], [Description], [ShipmentID], [ShipmentTrackingNumber], [EstimatedStoryPoints], [SpentStoryPoints], [DateCreated], [DateClosed], [StatusId], [CreatorUserId], [AssigneeUserId]) VALUES (3, N'Create a new API', N'Create the API for the CleverPoint case study', N'000003', N'000000001', 2, 2, CAST(N'2024-07-13T16:31:14.8870000' AS DateTime2), CAST(N'2024-07-14T17:31:14.8870000' AS DateTime2), 2, 2, 1)
GO
INSERT [dbo].[Tickets] ([Id], [Title], [Description], [ShipmentID], [ShipmentTrackingNumber], [EstimatedStoryPoints], [SpentStoryPoints], [DateCreated], [DateClosed], [StatusId], [CreatorUserId], [AssigneeUserId]) VALUES (4, N'Models and Database', N'Create the models and build the database', N'000004', N'000000001', 2, NULL, CAST(N'2024-07-13T16:31:14.8870000' AS DateTime2), NULL, 1, 2, 1)
GO
INSERT [dbo].[Tickets] ([Id], [Title], [Description], [ShipmentID], [ShipmentTrackingNumber], [EstimatedStoryPoints], [SpentStoryPoints], [DateCreated], [DateClosed], [StatusId], [CreatorUserId], [AssigneeUserId]) VALUES (5, N'Controller', N'Create the Users and Tickets controllers', N'000005', N'000000001', 3, NULL, CAST(N'2024-07-13T16:31:14.8870000' AS DateTime2), NULL, 1, 2, 1)
GO
